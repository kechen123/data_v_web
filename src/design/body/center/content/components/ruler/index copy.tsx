...
//     root.render(
//       <div className={`${style.hlineTemp} tempXLine`} style={{ height: height + 'px', left: ev.offsetX + 'px' }}>
//         <div className={`${style.txt} tempXTxt`}></div>
//       </div>
//     )
//   }
//   const XOut = () => {
...
//     const txt = document.querySelector('.tempXTxt ') as HTMLDivElement
//     if (!line || !txt || ev.target.className.indexOf('tempXLine') > -1) {
//       return
//     }

//     console.log(ev.offsetX)
//     line.style.left = ev.offsetX + 'px'
//     txt.innerText = num + 'px'
//   }
//   const x = {
//     width: width + 1000,
//     height: 20,
